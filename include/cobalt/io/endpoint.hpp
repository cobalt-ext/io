...
#ifndef BOOST_COBALT_EXPERIMENTAL_IO_ENDPOINT_HPP
#define BOOST_COBALT_EXPERIMENTAL_IO_ENDPOINT_HPP
...
COBALT_IO_DECL BOOST_NORETURN void
...
struct endpoint
{
  using storage_type = net::detail::sockaddr_storage_type;
  using addr_type = net::detail::socket_addr_type;
 ...
 private:
  union {
    net::detail::socket_addr_type base_{};
...
struct local_endpoint
{
 ...
 private:
  union {
    net::detail::sockaddr_storage_type addr_;
    net::detail::sockaddr_un_type unix_;
  };
};

COBALT_IO_DECL
std::size_t tag_invoke(make_endpoint_tag<AF_UNIX>,
                       net::detail::socket_addr_type* base,
                       std::string_view sv);
...
struct ip_address_v4
{
 ...
 private:
  union {
    net::detail::sockaddr_storage_type addr_{};
    net::detail::sockaddr_in4_type in_;
  };
};
...
struct ip_address_v6
{
 ...
 private:
  union {
    net::detail::sockaddr_storage_type addr_{};
    net::detail::sockaddr_in6_type in_;
  };
};
...
struct ip_address
{
 ...
 private:
  union {
    net::detail::sockaddr_storage_type addr_{};
    net::detail::sockaddr_in4_type in_;
    net::detail::sockaddr_in6_type in6_;
  };
};
...
#endif //BOOST_COBALT_EXPERIMENTAL_IO_ENDPOINT_HPP