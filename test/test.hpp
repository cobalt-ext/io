...
inline void test_run(boost::cobalt::task<void> (*func) ())
{
  ...
  boost::cobalt::pmr::unsynchronized_pool_resource res;
  boost::cobalt::this_thread::set_default_resource(&res);
#endif
  {
...
#if !defined(BOOST_COBALT_NO_PMR)
  boost::cobalt::this_thread::set_default_resource(boost::cobalt::pmr::get_default_resource());
#endif
}
