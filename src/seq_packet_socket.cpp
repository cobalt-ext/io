...
void seq_packet_socket::initiate_receive_(void *this_ , message_flags in, message_flags  * out, mutable_buffer_sequence seq, boost::cobalt::completion_handler<error_code, std::size_t> handler)
{
...
void seq_packet_socket::initiate_send_   (void * this_, message_flags in, const_buffer_sequence seq, boost::cobalt::completion_handler<error_code, std::size_t> handler)
{
  auto & s = static_cast<seq_packet_socket*>(this_)->seq_packet_socket_;
  if (seq.buffer_count() > 0u)
