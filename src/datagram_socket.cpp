...
#include <cobalt/io/datagram_socket.hpp>
...
void datagram_socket::initiate_receive_(void *this_ , mutable_buffer_sequence buffer, boost::cobalt::completion_handler<error_code, std::size_t> handler)
{
    initiate_async_receive(static_cast<datagram_socket*>(this_)->datagram_socket_, buffer, std::move(handler));

}
void datagram_socket::initiate_send_   (void * this_, const_buffer_sequence buffer, boost::cobalt::completion_handler<error_code, std::size_t> handler)
{
